...
* **2. Baixar:** Tem duas formas de obter os arquivos: Via Git: `git clone https://github.com/sawamur123/CipherVaultt.git` e via ZIP: Clique no botão verde "Code" no GitHub e selecione "Download ZIP". Extraia os arquivos em uma pasta.
